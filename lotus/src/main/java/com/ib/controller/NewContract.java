...
public class NewContract implements Cloneable {
    ...
    private Types.SecType m_secType = Types.SecType.None;
    private String m_expiry;
    private double m_strike;
    private Types.Right m_right = Types.Right.None;
    ...
    private Types.SecIdType m_secIdType = Types.SecIdType.None;
    ...
    public Types.SecIdType secIdType() { return m_secIdType; }
    public Types.SecType secType() { return m_secType; }
    ...
    public Types.Right right() { return m_right; }
    ...
    public void right(Types.Right v) { m_right = v; }
    public void secId(String v) { m_secId = v; }
    public void secIdType(Types.SecIdType v) { m_secIdType = v; }
    public void secType(Types.SecType v) { m_secType = v; }
    ...
    public NewContract() {
    	m_secType = Types.SecType.None;
    	m_secIdType = Types.SecIdType.None;
    }

    public NewContract( Contract c) {
    	m_conid = c.m_conId;
    	m_symbol = c.m_symbol;
    	m_secType = c.m_secType == null ? Types.SecType.None : Types.SecType.valueOf( c.m_secType);
    	m_expiry = c.m_expiry == null || c.m_expiry.equals( "0") ? "" : c.m_expiry;
    	m_strike = c.m_strike;
    	m_right = Types.Right.get( c.m_right);
    	...
    	m_secIdType = Types.SecIdType.get( c.m_secIdType);
    	m_secId = c.m_secId;
