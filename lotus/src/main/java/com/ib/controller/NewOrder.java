...
public class NewOrder {
	...
	private Types.Action m_action = Types.Action.BUY;
	...
	private Types.TimeInForce m_tif = Types.TimeInForce.DAY;
	...
	private Types.Rule80A m_rule80A = Types.Rule80A.None;
	private Types.OcaType m_ocaType = Types.OcaType.None;
	private Types.TriggerMethod m_triggerMethod = Types.TriggerMethod.Default;

	// advisor allocation orders
	private String m_faGroup;
	private Types.Method m_faMethod = Types.Method.None;
	...
	private Types.VolatilityType m_volatilityType = Types.VolatilityType.None;
	private boolean m_continuousUpdate;
	private Types.ReferencePriceType m_referencePriceType = Types.ReferencePriceType.None;
	...
	// hedge orders
	private Types.HedgeType m_hedgeType = Types.HedgeType.None;
	private String m_hedgeParam; // beta value for beta hedge (in range 0-1), ratio for pair hedge

	// algo orders
	private Types.AlgoStrategy m_algoStrategy = Types.AlgoStrategy.None;
...
//	private int m_basisPointsType;     // EFP orders only, download only
	...
	// getters
	public Types.Action action() { return m_action; }
	...
	public Types.Method faMethod() { return m_faMethod; }
	public Types.OcaType ocaType() { return m_ocaType; }
	public OrderType deltaNeutralOrderType() { return m_deltaNeutralOrderType; }
	public OrderType orderType() { return m_orderType; }
	public Types.ReferencePriceType referencePriceType() { return m_referencePriceType; }
	public Types.Rule80A rule80A() { return m_rule80A; }
	public String account() { return m_account; }
	public Types.AlgoStrategy algoStrategy() { return m_algoStrategy; }
	...
	public Types.HedgeType hedgeType() { return m_hedgeType; }
	public String ocaGroup() { return m_ocaGroup; }
	public String orderRef() { return m_orderRef; }
	public Types.TimeInForce tif() { return m_tif; }
	public Types.VolatilityType volatilityType() { return m_volatilityType; }
	public ArrayList<TagValue> smartComboRoutingParams() { return m_smartComboRoutingParams; }
	public Types.TriggerMethod triggerMethod() { return m_triggerMethod; }
	...
	public void action(Types.Action v) { m_action = v; }
	public void algoStrategy(Types.AlgoStrategy v) { m_algoStrategy = v; }
	...
	public void faMethod(Types.Method v) { m_faMethod = v; }
	...
	public void hedgeType(Types.HedgeType v) { m_hedgeType = v; }
	...
	public void ocaType(Types.OcaType v) { m_ocaType = v; }
	...
	public void referencePriceType(Types.ReferencePriceType v) { m_referencePriceType = v; }
	public void rule80A(Types.Rule80A v) { m_rule80A = v; }
	...
	public void tif(Types.TimeInForce v) { m_tif = v; }
	...
	public void triggerMethod(Types.TriggerMethod v) { m_triggerMethod = v; }
	public void volatility(double v) { m_volatility = v; }
	public void volatilityType(Types.VolatilityType v) { m_volatilityType = v; }
	...
	public NewOrder( Order order) {
		...
		m_action = Types.Action.valueOf( order.m_action);
		...
		m_tif = Types.TimeInForce.valueOf( order.m_tif);
		...
		m_rule80A = Types.Rule80A.get( order.m_rule80A);
		m_ocaType = Types.OcaType.get( order.m_ocaType);
		m_triggerMethod = Types.TriggerMethod.get( order.m_triggerMethod);
		m_faGroup = order.m_faGroup;
		m_faMethod = Types.Method.get( order.m_faMethod);
		m_faPercentage = order.m_faPercentage;
		m_faProfile = order.m_faProfile;
		m_volatility = order.m_volatility;
		m_volatilityType = Types.VolatilityType.get( order.m_volatilityType);
		m_continuousUpdate = order.m_continuousUpdate == 1;
		m_referencePriceType = Types.ReferencePriceType.get( order.m_referencePriceType);
		...
		m_hedgeType = Types.HedgeType.get( order.m_hedgeType);
		m_hedgeParam = order.m_hedgeParam;
		m_algoStrategy = Types.AlgoStrategy.get( order.m_algoStrategy);
