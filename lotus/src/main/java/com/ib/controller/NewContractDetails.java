...
public class NewContractDetails {
	...
	@Override public String toString() {
	    ...
	    NewContract.add( sb, "marketName", m_marketName);
	    NewContract.add( sb, "minTick", m_minTick);
	    NewContract.add( sb, "priceMagnifier", m_priceMagnifier);
	    NewContract.add( sb, "orderTypes", m_orderTypes);
	    NewContract.add( sb, "validExchanges", m_validExchanges);
	    NewContract.add( sb, "underConId", m_underConid);
	    NewContract.add( sb, "longName", m_longName);
	    NewContract.add( sb, "contractMonth", m_contractMonth);
	    NewContract.add( sb, "industry", m_industry);
	    NewContract.add( sb, "category", m_category);
	    NewContract.add( sb, "subcategory", m_subcategory);
	    NewContract.add( sb, "timeZoneId", m_timeZoneId);
	    NewContract.add( sb, "tradingHours", m_tradingHours);
	    NewContract.add( sb, "liquidHours", m_liquidHours);
	    NewContract.add( sb, "evRule", m_evRule);
	    NewContract.add( sb, "evMultiplier", m_evMultiplier);

	    NewContract.add( sb, "cusip", m_cusip);
	    NewContract.add( sb, "ratings", m_ratings);
	    NewContract.add( sb, "descAppend", m_descAppend);
	    NewContract.add( sb, "bondType", m_bondType);
	    NewContract.add( sb, "couponType", m_couponType);
	    NewContract.add( sb, "callable", m_callable);
	    NewContract.add( sb, "putable", m_putable);
	    NewContract.add( sb, "coupon", m_coupon);
	    NewContract.add( sb, "convertible", m_convertible);
	    NewContract.add( sb, "maturity", m_maturity);
	    NewContract.add( sb, "issueDate", m_issueDate);
	    NewContract.add( sb, "nextOptionDate", m_nextOptionDate);
	    NewContract.add( sb, "nextOptionType", m_nextOptionType);
	    NewContract.add( sb, "nextOptionPartial", m_nextOptionPartial);
	    NewContract.add( sb, "notes", m_notes);
